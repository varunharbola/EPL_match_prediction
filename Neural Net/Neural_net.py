...
def main(data_file):
    ...
    for i in range (9,20):
        clf=MLPClassifier(solver='sgd', alpha=2, activation='tanh', hidden_layer_sizes=(i), max_iter=20000)
        ...
        accuracy=np.sum(predictions==y_training)/len(y_training)
        print('NN accuracy for training'+str(i)+' nodes ='+str(accuracy))
        print(confusion_matrix(y_training,predictions))
        print(classification_report(y_training,predictions))
